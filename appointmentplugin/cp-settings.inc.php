            ...
            <tbody>
	    		<tr valign="top">
	    			...
	    			<td>
                        ...
                        <em>Enter field names comma separated, example: <b>final_price,referrer,fieldname1,fieldname2<b></em>
	    			</td>
	    		</tr>
	    		<tr valign="top">
	    			<th scope="row">
	    			...
	    			<td>
                        ...
                        <em>Enter field names comma separated, example: <b>paid,cancelled<b></em>
	    			</td>
	    		</tr>
	    	</tbody>
	    </table>
